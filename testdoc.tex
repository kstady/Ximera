...
\title{Test Document} %\author{Kelly}

\begin{document}

\begin{abstract} Seeing if his thing works once again  - sheesh!. \end{abstract} 
\maketitle
...
of the form $V= A \cos Bt + D, $  \hsapce{0.2in}  $0 \le t \le 8.$  Find the equation.    
